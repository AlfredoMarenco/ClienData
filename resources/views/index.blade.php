    ...
    <div class="container">
        <div class="titular-uno">
            <div class="text-center">
                ...
                <p>Somos una agencia de marketing digital que utiliza la tecnología a tu <br class="d-none d-sm-none d-md-block d-lg-block"> favor para elevar la
                    experiencia de atención a clientes y obtener leads <br class="d-none d-sm-none d-md-block d-lg-block"> de manera sostenida y eficiente</p>
        ...
        <div class="container">
            <div class="text-center">
                ...
                <p>Analizamos la información sobre conversaciones, preguntas frecuentes, solicitudes y dudas a lo largo
                    ...
                    automatizar procesos de ventas, generar clientes potenciales y fomentar la <br class="d-none d-sm-none d-md-block d-lg-block"> fidelidad de los clientes. Además, brindamos la
                    ventaja de estar disponibles las 24 horas y recopilar datos valiosos <br class="d-none d-sm-none d-md-block d-lg-block">para mejorar la estrategia de marketing de tu
                    empresa.</p>
                <img src="{{ asset('img/2023/secuencias.webp') }}" class="img-fluid" alt="Ejemplo de secuencia manychat por agenciavandu.com">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="titular-tres">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="text-center">
                        <img src="{{ asset('img/2023/web.webp') }}" width="auto" height="428" alt="Portal de pagos por agenciavandu.com">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="titular-cuatro text-center">
                ...
                <div class="d-none d-sm-none d-md-block d-lg-block">
                    <img src="{{ asset('img/2023/aliados.svg') }}" width="100%" height="auto" alt="Aliados de agenciavandu.com">
                </div>
                <div class="d-block d-sm-block d-md-none d-lg-none">
                    <img src="{{ asset('img/2023/m-aliados.svg') }}" width="100%" height="auto" alt="aliados agenciavandu.com">
                </div>
            </div>
    ...
    <div class="titular-cinco">
        <div class="container">
            <div class="text-center">
                ...
                <p>Imagina que estás participando en una carrera de autos en un circuito de alta velocidad.<br class="d-none d-sm-none d-md-block d-lg-block">Para tener éxito en esta competencia, necesitas
