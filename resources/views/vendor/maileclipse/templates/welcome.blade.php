...
<body bgcolor="#f7f7f7">
    <table class="container-for-gmail-android" width="100%" cellspacing="0" cellpadding="0" align="center">
        <tbody>
            <tr>
                <td style="background: repeat-x url('http://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg') #ffffff;"
                    align="left" valign="top" width="100%">
                    <center><img class="force-width-gmail"
                            src="http://s3.amazonaws.com/swu-filepicker/SBb2fQPrQ5ezxmqUTgCr_transparent.png" />
                        <table style="background-color: transparent;" width="100%" cellspacing="0" cellpadding="0"
                            bgcolor="#ffffff">
                            <tbody>
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" valign="top" width="100%"
                                        height="80">
                                        <!-- [if gte mso 9]>
            ...
            <tr>
                    ...
                    <center>
                        <table class="w320" width="600" cellspacing="0" cellpadding="0">
                            <tbody>
                                ...
                                <tr>
                                    <td class="free-text">Thank you for signing up with awesome co! We hope you enjoy
                                        your time with us. Check out some of our newest offers below or the button to
                                        view your new account.</td>
                                </tr>
                                <tr>
                                    <td class="button">
                                        <div>
              ...
              <![endif]--><a class="button-mobile"
                                                ...
                                                href="http://clientdata.test">My Account</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <center>
                        <table class="w320" width="600" cellspacing="0" cellpadding="0">
                            <tbody>
                                ...
                                <![endif]--><a class="button-width" style="background-color: #ff6f6f; border-radius: 5px; color: #ffffff; display: inline-block; font-family: 'Cabin', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: regular; line-height: 45px; text-align: center; text-decoration: none; -webkit-text-size-adjust: none; mso-hide: all;"
                                                                                                href="http://clientdata.test">View
                                                                                                Now!</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                ...
                <td style="background-color: #f7f7f7; height: 100px;" align="center" valign="top" width="100%">
                    <center>
                        <table class="w320" width="600" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td style="padding: 25px 0 25px;"><strong>Awesome Inc</strong><br />1234 Awesome St
                                        <br />Wonderland <br /><br /></td>
                                </tr>
                            </tbody>
                        </table>
                    </center>
