...
@section('content')
    ...
    <section class="amenidades mt-5">
        <div class="container">
            <div class="certeza__titular text-center pb-4">
                <h3>Cautiva tus sentidos con cada espacio de Ciudad Central Mérida</h3>
                <p>Disfruta de todo lo que Ciudad Central Mérida te ofrece y mejora tu calidad de vida.
                </p>
            </div>
