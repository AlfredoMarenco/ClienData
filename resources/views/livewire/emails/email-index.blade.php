<div>
    ...
    <div class="block lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link :active="$nav_emails" wire:click="navigation('emails')" class="cursor-pointer">
                {{ __('Emails') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link :active="$nav_templates" wire:click="navigation('templates')" class="cursor-pointer">
                {{ __('Templates') }}
            </x-jet-responsive-nav-link>
        </div>
    </div>
