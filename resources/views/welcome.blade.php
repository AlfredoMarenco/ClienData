...
<head>
    ...
    <meta name="og:image" content="https://cleex.com.mx/wp-content/uploads/2020/09/vandu-1024x538-1.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:description" content="Agencia de diseño web y digitalización de procesos en México y Mérida." />
    <meta name="twitter:title"
        content="Agencia de diseño web y digitalización de procesos en México y Mérida &mdash; Vandu" />
    <meta name="twitter:site" content="@vandumex" />
    <meta name="twitter:image" content="https://cleex.com.mx/wp-content/uploads/2020/09/vandu-1024x538-1.png" />
    <meta name="twitter:creator" content="@vandumex" />
...
<body>
                ...
                <div class="col-md-6 col-sm-12 col-lg-6">
                    <div class="row">
                        <div class="col-6 soluciones">
                            <img src="/img/icon/Ticket-Star.svg" class="img-fluid" alt="iconografia agencia vandu">
                        ...
                        <div class="col-6 soluciones">
                            <img src="/img/icon/Calendar.svg" class="img-fluid" alt="iconografia agencia vandu">
                        ...
                        <div class="col-6 soluciones">
                            <img src="/img/icon/Activity.svg" class="img-fluid" alt="iconografia agencia vandu">
                            <h4 class="pt-3 titular-i">Facebook Ads</h4>
                            <p>Gestionamos tus anuncios y agilizamos las coneversiones de tus redes sociales. </p>
                        </div>
                        <div class="col-6 soluciones">
                            <img src="/img/icon/Image.svg" class="img-fluid" alt="iconografia agencia vandu">
    ...
    <footer id="footer-section" class="bgfooter pt-5">
        <div class="container">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <p style="text-align: center; "><span><a href="https://www.facebook.com/vandumx" target="_blank"><i
                        ...
                        <a href="https://www.behance.net/vandumx" target="_blank" style="padding-left: 20px;"><i
                                class="fab fa-behance-square" style="font-size: 19px;"></i></a></i>
                        <a href="https://www.linkedin.com/company/vandu-mx" target="_blank"
                            style="padding-left: 20px;"><i class="fab fa-linkedin"
                                style="font-size: 19px;"></i></a></i>
                    </p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h1>Mapa del sitio</h1>
                    <hr>
                    <a href="#cabecera" style="text-decoration: none;">
                        <p>Inicio</p>
                    </a>
                    <a href="#como-funciona" style="text-decoration: none;">
                        <p>Cómo funciona</p>
                    </a>
                    <a href="#Por-que-nosotros" style="text-decoration: none;">
            ...
            <div class="row pt-5 mt-5 text-center bgfooter">
                <div class="col-md-12">
                    <div class="border-top pt-5" style="color: gray;">
    ...
    <script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/5944303.js"></script>
    <!-- End of HubSpot Embed Code -->
    <script type="text/javascript">
        _linkedin_partner_id = "2414826";
        window._linkedin_data_partner_ids = window._linkedin_data_partner_ids || [];
        window._linkedin_data_partner_ids.push(_linkedin_partner_id);
    </script>
    <noscript>
        <img height="1" width="1" style="display:none;" alt=""
            src="https://px.ads.linkedin.com/collect/?pid=2414826&fmt=gif" />
    </noscript>
    ...
    <script>
        ...
        window.sr = ScrollReveal();
        sr.reveal(".bg-victory", {
            duration: 1000,
            origin: "ease-in"
        });
        window.sr = ScrollReveal();
        sr.reveal(".equipo-de-tres", {
            duration: 1000,
            origin: "bottom",
            distance: "100px"
        });
